...
<html>
  ...
  <body>
    <div id="login"><a href="Login.jsp">Login</a> &nbsp;|&nbsp; <a href="Signup.jsp">Sign
        up</a> </div>
    <!-- Header -->
    <section id="header">
      <header> <br>
        <h1>Snap-l-earn</h1>
        <h1> </h1>
        <p>Pranav And Rahul</p>
      </header>
      <footer> <a href="#banner" class="button style2 scrolly-middle">Explore</a>
      </footer>
    </section>
    <!-- Banner -->
    <section id="banner">
      ...
      <p>Calling all photographers to learn, earn and showcase their skills here
        with us.</p>
      <p>We wish for the photography hobbyist to fall in love with photography!</p>
      <footer> <a href="#first" class="button style2 scrolly">Let's dive!</a> </footer>
    </section>
    <!-- Portfolio -->
    <article id="first" class="container box style2">
      ...
      <div class="inner gallery">
        <div class="row 0%">
          <div class="3u"><a href="images/01.jpg" class="image fit"><img

                src="images/01.jpg" alt="" title="Ad infinitum"></a></div>
          <div class="3u"><a href="images/02.jpg" class="image fit"><img

                src="images/02.jpg" alt="" title="Dressed in Clarity"></a></div>
          <div class="3u"><a href="images/03.jpg" class="image fit"><img

                src="images/03.jpg" alt="" title="Raven"></a></div>
          <div class="3u"><a href="images/04.jpg" class="image fit"><img

                src="images/04.jpg" alt="" title="I'll have a cup of Disneyland, please"></a></div>
        </div>
        <div class="row 0%">
          <div class="3u"><a href="images/05.jpg" class="image fit"><img

                src="images/05.jpg" alt="" title="Cherish"></a></div>
          <div class="3u"><a href="images/06.jpg" class="image fit"><img

                src="images/06.jpg" alt="" title="Different."></a></div>
          <div class="3u"><a href="images/07.jpg" class="image fit"><img

                src="images/07.jpg" alt="" title="History was made here"></a></div>
          <div class="3u"><a href="images/08.jpg" class="image fit"><img

                src="images/08.jpg" alt="" title="People come and go and walk away"></a></div>
        </div>
      </div>
    </article>
    <!-- Generic -->
